    ...
    def __call__(self, inputs, training):
        ...
        with self._model_variable_scope():
            if self.data_format == 'channels_first':
                ...
                # tensorflow.org/performance/performance_guide#data_formats
            ...
            # perform these for both the shortcut and non-shortcut paths
            # as part of the first block's projection. Cf. Appendix of [2].
            ...
            # Only apply the BN and ReLU for model that
            # does pre_activation in each
