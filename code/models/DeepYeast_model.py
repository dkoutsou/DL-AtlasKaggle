...
class DeepYeastModel(BaseModel):
    ...
    def build_model(self):
        ...
        x = tf.layers.max_pooling2d(x, pool_size = (2,2), strides=(2,2), name='pool1')
        # Block 2
        ...
        x = tf.layers.max_pooling2d(x, pool_size = (2,2), strides=(2,2), name='pool2')    
        # Block 3
        ...
        x = tf.layers.max_pooling2d(x, pool_size = (2,2), strides=(2,2), name='pool3') 
